all: main.c update.o JSON_action.o JSON_request_handle.o config.o update_local.o JSON_action_local.o config_local.o JSON_request_handle_local.o help.o
	mipsel-openwrt-linux-gcc -std=c99 -I./include main.c update.o JSON_action.o JSON_request_handle.o config.o help.o -Wl,-rpath-link=$(TOOLCHAIN_DIR)lib -lcurl -o ap_client
...
#	gcc -std=c99 -I./include test.c JSON_request_handle_local.o -lcurl -o testpro
	...
	mipsel-openwrt-linux-gcc -std=c99 -I./include intergrate_test.c JSON_action.o JSON_request_handle.o config.o update.o -Wl,-rpath-link=$(TOOLCHAIN_DIR)lib -lcurl -o intergrate_test_ap
	rm *.o
update.o: update.c
